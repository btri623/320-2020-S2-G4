...
public class HelloWorld : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            message = "recoButton is Null! Assign a UI Button to it.";
    ...
    void FixedUpdate()
    {
        ...
        {
            GameObject.Find("RecordButton").GetComponentInChildren<TextMesh>().text = "Stop";
        ...
        else if (!Microphone.IsRecording(Microphone.devices[0]) && recognitionStarted == false)
        {
            ...
            recordButton.GetComponentInChildren<TextMesh>().text = "Record";
        }
    }
}
